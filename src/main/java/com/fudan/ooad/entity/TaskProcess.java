...
public class TaskProcess {
    ...
    public Set<CheckItemProcess> getCheckItemProcesses() {
        return checkItemProcesses;
    }

    public void setCheckItemProcesses(Set<CheckItemProcess> checkItemProcesses) {
        this.checkItemProcesses = checkItemProcesses;
    }
